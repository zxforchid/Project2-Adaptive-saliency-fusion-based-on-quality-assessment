function [rec, prec, fm03, fm05, fm07, fm09, fm1, hdlY] = Draw_PRF_Curve_testlist1(testlist, SMAP, smapSuffix, GT, gtSuffix, targetIsFg, targetIsHigh, color)
...
% plot
if nargin > 5
    hdlY = plot(rec, prec, 'color', color,'LineStyle','--','linewidth', 2);
