function [precision,recall ,f02, f03 ,f05 ,f07,f09,f1] = Evaluate_Post3(ACTUAL,PREDICTED)
...
a=0.2;b=0.3; c=0.5;d = 0.7;e = 0.9; f=1;                              %b=beta^2

if (b*precision + recall)~=0
f02 = ((1+a)*precision*recall)/(a*precision + recall);
f03 = ((1+b)*precision*recall)/(b*precision + recall);
...
f02 = 0; f03=0;f05=0;f07=0;f09=0;f1=0;
end
