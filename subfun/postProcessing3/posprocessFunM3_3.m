function outputFileID = posprocessFunM3_3(i, init_infor,testName,testorvalid, lambdaPara)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
colorDist = (m1(E(:,1))-m1(E(:,2))).^2+(m2(E(:,1))-m2(E(:,2))).^2+(m3(E(:,1))-m3(E(:,2)));
...
sal2 = double(imread([imgwritepath,imname,'_m3_1.png']));sal2 = normalize_sal(sal2);
% sals{1,1} = sal1; 
sals{1,1} = sal2;
clear sal1 sal2
