function [aveP,aveR,aveFM02, aveFM03,aveFM05,aveFM07, aveFM09, aveFM1] = compute_average_prf_Post3(SMAP, smapSuffix, GT, gtSuffix)
...
%      [precision,recall ,f_measure ,f05 ,f1] = Evaluate(gtImg,cutimg);
     [precision,recall ,f02, f03 ,f05 ,f07,f09,f1]= Evaluate_Post3(gtImg,cutimg);
     aveP1(k,1)    = precision;
     aveR1(k,1)    = recall;
     aveFM021(k,1) = f02;
     aveFM031(k,1) = f03;
