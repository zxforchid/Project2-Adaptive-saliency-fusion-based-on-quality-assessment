function [recall_avg, precision_avg ,fpr_avg ,tpr_avg,auc_curve,aucs] = myCurveCompute(groundtruthsPath,imgPath,extname)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% version1:
...
%     clear imgT;
     ...
     [precision(:,i),recall(:,i),tpr(:,i),fpr(:,i),psort] = computesinglePRF(BinarymaskNames,groundtruthsPath,imgPath,extname,i);
