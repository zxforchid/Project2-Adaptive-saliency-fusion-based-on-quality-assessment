function imsegs = processSuperpixelImage_forSLIC(fn,spNum)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% version1:
...
%
% version2:
% make a little change for SLIC method
% Copyright(C) Xiaofei Zhou,Shanghai University,Shanghai,China
% Current version: 2.0 06/16/2015
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%        
% if isstr(fn)
%     fn = {fn};
% end
